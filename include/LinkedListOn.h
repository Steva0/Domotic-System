...
class LinkedListOn: public LinkedList
{
    ...
    std::vector<Dispositivo> removeAllDevicesOff(const int currentTime);                //rimuove tutti i dispositivi spenti (il cui orario di spegnimento e' prima dell'orario indicato) e li restituisce tutti in un vector            
    ...
    double getActualConsumption() const;                                                   //restituisce il consumo totale        
